...
TOPIC_PROMINENCE_COL = "O_Sent"  # Coded topic column
TOPIC_SENTIMENT_COL = "O_Sent"   # Coded topic column  
TOPIC_STATE_COL = "O_State"      # Coded topic state

OUTLET_SCORE_COL = "Orchestra_Pub_Tier"  # Coded outlet score
PUB_TIER_COL = "Orchestra_Pub_Tier"      # Coded pub tier
...
def process(csv_path: str) -> str:
    ...
    # Check required metadata columns - coded format only
    if OUTLET_SCORE_COL not in df.columns:
        missing_cols.append(OUTLET_SCORE_COL)
